...
def valid_scene(**overrides):
    fields = {
        ...
        "character_state_refs": "project/characters/X_01_protagonist.md",
...
class SceneReadinessMechanicsTests(unittest.TestCase):
    def test_valid_scene_reaches_human_gate_but_is_not_auto_approved(self):
    ...
    def test_missing_required_field_blocks(self):
        text = valid_scene().replace("consequence_carrier: Zugriff wird protokolliert und Gegenfigur reagiert auf die Entscheidung\n", "")
    ...
    def test_unresolved_research_blocks(self):
